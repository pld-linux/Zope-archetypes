...
%build
mkdir docs docs/{Archetypes,MimetypesRegistry,generator,validation}
...
cp -af Archetypes-%{version}-%{sub_ver}/{Archetypes,MimetypesRegistry,generator,validation} $RPM_BUILD_ROOT%{_datadir}/%{name}
...
%post
for p in Archetypes MimetypesRegistry generator validation; do
